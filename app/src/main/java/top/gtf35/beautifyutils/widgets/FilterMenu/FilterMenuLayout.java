package top.gtf35.beautifyutils.widgets.FilterMenu;
...
public class FilterMenuLayout extends ViewGroup {
    ...
    private void init(Context ctx, AttributeSet attrs) {
        ...
        primaryColor = getResources().getColor(android.R.color.holo_blue_bright);
        ...
        primaryDarkColor = getResources().getColor(android.R.color.holo_blue_dark);
        //ta.recycle();
